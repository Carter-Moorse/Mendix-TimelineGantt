...
export interface TimelineGanttContainerProps {
    ...
    onMove?: ListActionValue<{ StartDate: Option<Date>; EndDate: Option<Date> }>;
    onMoveToGroup?: ListActionValue<{ StartDate: Option<Date>; EndDate: Option<Date>; GroupRef: Option<string>; GroupGUID: Option<string> }>;
    editableAdd: boolean;
