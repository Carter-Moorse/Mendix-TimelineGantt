...
export interface TimelineGanttContainerProps {
    ...
    item_doubleClick?: ListActionValue;
    ...
    group_onMoveRef?: ListAttributeValue<Big | Date | string>;
    item_onMove?: ListActionValue<{ StartDate: Option<Date>; EndDate: Option<Date> }>;
    item_onMoveToGroup?: ListActionValue<{ StartDate: Option<Date>; EndDate: Option<Date>; GroupRef: Option<string>; GroupGUID: Option<string> }>;
    editableAdd: boolean;
    item_onAdd?: ActionValue<{ StartDate: Option<Date>; EndDate: Option<Date> }>;
    item_onAddToGroup?: ListActionValue<{ StartDate: Option<Date>; EndDate: Option<Date> }>;
    editableRemove: boolean;
    item_remove?: ListExpressionValue<boolean>;
    item_onRemove?: ListActionValue;
    ...
    group_doubleClick?: ListActionValue;
}
...
export interface TimelineGanttPreviewProps {
    ...
    group_onMoveRef: string;
    item_onMove: {} | null;
    item_onMoveToGroup: {} | null;
    editableAdd: boolean;
    item_onAdd: {} | null;
    item_onAddToGroup: {} | null;
    editableRemove: boolean;
    item_remove: string;
    item_onRemove: {} | null;
